    ...
    def __init__(self, file_path: str, mesh: Mesh, cell_centered: bool):
        ...
        with open(self.file_path, 'rb') as infile:
            ...
            for patch_info in patch_infos:
                ...
                self.obstructions[patch_info[7] + 1]._add_patch(mesh, Patch(extent, orientation, self.cell_centered))
...
class Boundary:
    ...
    def _add_subboundary(self, filename: str, mesh: Mesh):
        self._subboundaries[mesh] = subboundary = SubBoundary(mesh)

# Each BND is for one Mesh
# Contains data for N Obstacles
# Header + for t [time + N*Obstacle * 6*Patch]
